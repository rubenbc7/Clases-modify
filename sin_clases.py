...
obstaculo.PosicionX = 0.0
obstaculo.PosicionY = 0.6
obstaculoVivo = True
...
def actualizar_bala(tiempo_delta):
    ...
    if disparando:
        ...
        if obstaculoVivo and xBala + 0.01 > obstaculo.PosicionX - 0.15 and xBala - 0.01 < obstaculo.PosicionX + 0.15 and yBala + 0.01 > obstaculo.PosicionY - 0.15 and yBala - 0.01 < obstaculo.PosicionY + 0.15:
            obstaculoVivo = False
            disparando = False
...
def checar_colisiones():
    ...
    if xCarrito + 0.05 > obstaculo.PosicionX - 0.15 and xCarrito - 0.05 < obstaculo.PosicionX + 0.15 and yCarrito + 0.05 > obstaculo.PosicionY - 0.15 and yCarrito - 0.05 < obstaculo.PosicionY + 0.15:
        colisionando = True
    else:
        colisionando = False
...
def dibujarObstaculo():
    global obstaculo.PosicionX
    global obstaculo.PosicionY

    if obstaculoVivo:
        glPushMatrix()
        glTranslate(obstaculo.PosicionX, obstaculo.PosicionY, 0.0)
        glBegin(GL_QUADS)
